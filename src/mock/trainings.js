export const MOCK_TRAININGS = [
  {
    ...
    checkinRecords: [
      ...
      { studentId: 'u009', name: '罗强', time: '09:03', date: '2025-03-10', status: 'on_time' },
      { studentId: 'u010', name: '覃玉兰', time: '09:22', date: '2025-03-10', status: 'late' },
      { studentId: 'u011', name: '梁海燕', time: '09:00', date: '2025-03-10', status: 'on_time' },
    ],
  },
  {
    id: 't002',
  ...
  },
  {
    ...
    checkinRecords: [
      { studentId: 'u004', name: '陈小红', time: '08:55', date: '2024-12-05', status: 'on_time' },
      { studentId: 'u016', name: '李大明', time: '09:10', date: '2024-12-05', status: 'late' },
      { studentId: 'u017', name: '黄秀华', time: '08:58', date: '2024-12-05', status: 'on_time' },
      { studentId: 'u018', name: '陈志远', time: null, date: '2024-12-05', status: 'absent' },
    ],
  },
  {
    id: 't004',
    ...
    checkinRecords: [
      { studentId: 'u003', name: '张伟', time: '09:00', date: '2025-03-03', status: 'on_time' },
      { studentId: 'u005', name: '黄明', time: '09:08', date: '2025-03-03', status: 'on_time' },
      { studentId: 'u019', name: '韦志鹏', time: '09:18', date: '2025-03-03', status: 'late' },
      { studentId: 'u020', name: '廖宇航', time: '09:02', date: '2025-03-03', status: 'on_time' },
    ],
  },
  {
    id: 't005',
    ...
    checkinRecords: [
      { studentId: 'u006', name: '韦大勇', time: '08:59', date: '2025-03-10', status: 'on_time' },
      { studentId: 'u008', name: '蓝天宇', time: '09:12', date: '2025-03-10', status: 'late' },
      { studentId: 'u021', name: '谢建国', time: '09:01', date: '2025-03-10', status: 'on_time' },
      { studentId: 'u022', name: '林丽萍', time: '09:00', date: '2025-03-10', status: 'on_time' },
      { studentId: 'u023', name: '苏伟强', time: null, date: '2025-03-10', status: 'absent' },
    ],
  },
  {
    id: 't006',
  ...
  },
  {
    ...
    checkinRecords: [
      { studentId: 'u024', name: '黎明远', time: '08:50', date: '2024-10-14', status: 'on_time' },
      { studentId: 'u025', name: '莫云飞', time: '09:00', date: '2024-10-14', status: 'on_time' },
      { studentId: 'u026', name: '潘玉凤', time: '08:55', date: '2024-10-14', status: 'on_time' },
      { studentId: 'u027', name: '周志军', time: '09:05', date: '2024-10-14', status: 'late' },
    ],
  },
  {
    id: 't008',
